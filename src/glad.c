/*
    ...
    OpenGL loader generated by glad 0.1.36 on Thu Mar  9 09:17:48 2023.
...
static void load_GL_AMD_gpu_shader_int64(GLADloadproc load) {
	...
	glad_glUniform1i64vNV =
	    (PFNGLUNIFORM1I64VNVPROC)load("glUniform1i64vNV");
	glad_glUniform2i64vNV =
	    (PFNGLUNIFORM2I64VNVPROC)load("glUniform2i64vNV");
	glad_glUniform3i64vNV =
	    (PFNGLUNIFORM3I64VNVPROC)load("glUniform3i64vNV");
	glad_glUniform4i64vNV =
	    (PFNGLUNIFORM4I64VNVPROC)load("glUniform4i64vNV");
	glad_glUniform1ui64NV =
	    (PFNGLUNIFORM1UI64NVPROC)load("glUniform1ui64NV");
	glad_glUniform2ui64NV =
	    (PFNGLUNIFORM2UI64NVPROC)load("glUniform2ui64NV");
	glad_glUniform3ui64NV =
	    (PFNGLUNIFORM3UI64NVPROC)load("glUniform3ui64NV");
	glad_glUniform4ui64NV =
	    (PFNGLUNIFORM4UI64NVPROC)load("glUniform4ui64NV");
...
static void load_GL_AMD_name_gen_delete(GLADloadproc load) {
	...
	glad_glDeleteNamesAMD =
	    (PFNGLDELETENAMESAMDPROC)load("glDeleteNamesAMD");
...
static void load_GL_ARB_bindless_texture(GLADloadproc load) {
	...
	glad_glIsImageHandleResidentARB =
	    (PFNGLISIMAGEHANDLERESIDENTARBPROC)load(
	...
	glad_glGetVertexAttribLui64vARB =
	    (PFNGLGETVERTEXATTRIBLUI64VARBPROC)load(
...
static void load_GL_ARB_cl_event(GLADloadproc load) {
	...
	glad_glCreateSyncFromCLeventARB =
	    (PFNGLCREATESYNCFROMCLEVENTARBPROC)load(
...
static void load_GL_ARB_gpu_shader_int64(GLADloadproc load) {
	...
	glad_glUniform1i64ARB =
	    (PFNGLUNIFORM1I64ARBPROC)load("glUniform1i64ARB");
	glad_glUniform2i64ARB =
	    (PFNGLUNIFORM2I64ARBPROC)load("glUniform2i64ARB");
	glad_glUniform3i64ARB =
	    (PFNGLUNIFORM3I64ARBPROC)load("glUniform3i64ARB");
	glad_glUniform4i64ARB =
	    (PFNGLUNIFORM4I64ARBPROC)load("glUniform4i64ARB");
...
static void load_GL_ARB_imaging(GLADloadproc load) {
	...
	glad_glResetHistogram =
	    (PFNGLRESETHISTOGRAMPROC)load("glResetHistogram");
...
static void load_GL_ARB_robustness(GLADloadproc load) {
	...
	glad_glReadnPixelsARB =
	    (PFNGLREADNPIXELSARBPROC)load("glReadnPixelsARB");
	...
	glad_glGetnConvolutionFilterARB =
	    (PFNGLGETNCONVOLUTIONFILTERARBPROC)load(
...
static void load_GL_ARB_shader_objects(GLADloadproc load) {
	...
	glad_glLinkProgramARB =
	    (PFNGLLINKPROGRAMARBPROC)load("glLinkProgramARB");
...
static void load_GL_ARB_shading_language_include(GLADloadproc load) {
	...
	glad_glNamedStringARB =
	    (PFNGLNAMEDSTRINGARBPROC)load("glNamedStringARB");
...
static void load_GL_ARB_vertex_blend(GLADloadproc load) {
	...
	glad_glVertexBlendARB =
	    (PFNGLVERTEXBLENDARBPROC)load("glVertexBlendARB");
}
static void load_GL_ARB_vertex_buffer_object(GLADloadproc load) {
	...
	glad_glUnmapBufferARB =
	    (PFNGLUNMAPBUFFERARBPROC)load("glUnmapBufferARB");
...
static void load_GL_ATI_draw_buffers(GLADloadproc load) {
	...
	glad_glDrawBuffersATI =
	    (PFNGLDRAWBUFFERSATIPROC)load("glDrawBuffersATI");
}
static void load_GL_ATI_element_array(GLADloadproc load) {
	...
	glad_glDrawRangeElementArrayATI =
	    (PFNGLDRAWRANGEELEMENTARRAYATIPROC)load(
...
static void load_GL_ATI_envmap_bumpmap(GLADloadproc load) {
	...
	glad_glGetTexBumpParameterivATI =
	    (PFNGLGETTEXBUMPPARAMETERIVATIPROC)load(
		"glGetTexBumpParameterivATI");
	glad_glGetTexBumpParameterfvATI =
	    (PFNGLGETTEXBUMPPARAMETERFVATIPROC)load(
...
static void load_GL_ATI_vertex_array_object(GLADloadproc load) {
	...
	glad_glArrayObjectATI =
	    (PFNGLARRAYOBJECTATIPROC)load("glArrayObjectATI");
...
static void load_GL_EXT_coordinate_frame(GLADloadproc load) {
	...
	glad_glBinormal3bvEXT =
	    (PFNGLBINORMAL3BVEXTPROC)load("glBinormal3bvEXT");
	glad_glBinormal3dEXT = (PFNGLBINORMAL3DEXTPROC)load("glBinormal3dEXT");
	glad_glBinormal3dvEXT =
	    (PFNGLBINORMAL3DVEXTPROC)load("glBinormal3dvEXT");
	...
	glad_glBinormal3ivEXT =
	    (PFNGLBINORMAL3IVEXTPROC)load("glBinormal3ivEXT");
	glad_glBinormal3sEXT = (PFNGLBINORMAL3SEXTPROC)load("glBinormal3sEXT");
	glad_glBinormal3svEXT =
	    (PFNGLBINORMAL3SVEXTPROC)load("glBinormal3svEXT");
...
static void load_GL_EXT_debug_label(GLADloadproc load) {
	...
	glad_glLabelObjectEXT =
	    (PFNGLLABELOBJECTEXTPROC)load("glLabelObjectEXT");
...
static void load_GL_EXT_depth_bounds_test(GLADloadproc load) {
	...
	glad_glDepthBoundsEXT =
	    (PFNGLDEPTHBOUNDSEXTPROC)load("glDepthBoundsEXT");
}
static void load_GL_EXT_direct_state_access(GLADloadproc load) {
	...
	glad_glMatrixLoadfEXT =
	    (PFNGLMATRIXLOADFEXTPROC)load("glMatrixLoadfEXT");
	glad_glMatrixLoaddEXT =
	    (PFNGLMATRIXLOADDEXTPROC)load("glMatrixLoaddEXT");
	glad_glMatrixMultfEXT =
	    (PFNGLMATRIXMULTFEXTPROC)load("glMatrixMultfEXT");
	glad_glMatrixMultdEXT =
	    (PFNGLMATRIXMULTDEXTPROC)load("glMatrixMultdEXT");
	...
	glad_glMatrixOrthoEXT =
	    (PFNGLMATRIXORTHOEXTPROC)load("glMatrixOrthoEXT");
	...
	glad_glGetFloati_vEXT =
	    (PFNGLGETFLOATI_VEXTPROC)load("glGetFloati_vEXT");
...
static void load_GL_EXT_external_buffer(GLADloadproc load) {
	...
	glad_glBufferStorageExternalEXT =
	    (PFNGLBUFFERSTORAGEEXTERNALEXTPROC)load(
...
static void load_GL_EXT_framebuffer_blit_layers(GLADloadproc load) {
	...
	glad_glBlitFramebufferLayersEXT =
	    (PFNGLBLITFRAMEBUFFERLAYERSEXTPROC)load(
...
static void load_GL_EXT_gpu_shader4(GLADloadproc load) {
	...
	glad_glUniform2uivEXT =
	    (PFNGLUNIFORM2UIVEXTPROC)load("glUniform2uivEXT");
	glad_glUniform3uivEXT =
	    (PFNGLUNIFORM3UIVEXTPROC)load("glUniform3uivEXT");
	glad_glUniform4uivEXT =
	    (PFNGLUNIFORM4UIVEXTPROC)load("glUniform4uivEXT");
...
static void load_GL_EXT_histogram(GLADloadproc load) {
	...
	glad_glResetMinmaxEXT =
	    (PFNGLRESETMINMAXEXTPROC)load("glResetMinmaxEXT");
}
...
static void load_GL_EXT_memory_object(GLADloadproc load) {
	...
	glad_glNamedBufferStorageMemEXT =
	    (PFNGLNAMEDBUFFERSTORAGEMEMEXTPROC)load(
...
static void load_GL_EXT_memory_object_win32(GLADloadproc load) {
	...
	glad_glImportMemoryWin32NameEXT =
	    (PFNGLIMPORTMEMORYWIN32NAMEEXTPROC)load(
...
static void load_GL_EXT_secondary_color(GLADloadproc load) {
	...
	glad_glSecondaryColorPointerEXT =
	    (PFNGLSECONDARYCOLORPOINTEREXTPROC)load(
...
static void load_GL_EXT_semaphore(GLADloadproc load) {
	...
	glad_glIsSemaphoreEXT =
	    (PFNGLISSEMAPHOREEXTPROC)load("glIsSemaphoreEXT");
...
static void load_GL_EXT_vertex_array(GLADloadproc load) {
	...
	glad_glGetPointervEXT =
	    (PFNGLGETPOINTERVEXTPROC)load("glGetPointervEXT");
...
static void load_GL_EXT_vertex_shader(GLADloadproc load) {
	...
	glad_glBindMaterialParameterEXT =
	    (PFNGLBINDMATERIALPARAMETEREXTPROC)load(
...
static void load_GL_IBM_multimode_draw_arrays(GLADloadproc load) {
	...
	glad_glMultiModeDrawElementsIBM =
	    (PFNGLMULTIMODEDRAWELEMENTSIBMPROC)load(
...
static void load_GL_INTEL_performance_query(GLADloadproc load) {
	...
	glad_glGetFirstPerfQueryIdINTEL =
	    (PFNGLGETFIRSTPERFQUERYIDINTELPROC)load(
...
static void load_GL_KHR_debug(GLADloadproc load) {
	...
	glad_glObjectLabelKHR =
	    (PFNGLOBJECTLABELKHRPROC)load("glObjectLabelKHR");
	...
	glad_glGetPointervKHR =
	    (PFNGLGETPOINTERVKHRPROC)load("glGetPointervKHR");
}
...
static void load_GL_KHR_robustness(GLADloadproc load) {
	...
	glad_glReadnPixelsKHR =
	    (PFNGLREADNPIXELSKHRPROC)load("glReadnPixelsKHR");
...
static void load_GL_NVX_gpu_multicast2(GLADloadproc load) {
	...
	glad_glAsyncCopyImageSubDataNVX =
	    (PFNGLASYNCCOPYIMAGESUBDATANVXPROC)load(
...
static void load_GL_NV_blend_equation_advanced(GLADloadproc load) {
	...
	glad_glBlendBarrierNV =
	    (PFNGLBLENDBARRIERNVPROC)load("glBlendBarrierNV");
}
...
static void load_GL_NV_command_list(GLADloadproc load) {
	...
	glad_glDrawCommandsNV =
	    (PFNGLDRAWCOMMANDSNVPROC)load("glDrawCommandsNV");
...
static void load_GL_NV_depth_buffer_float(GLADloadproc load) {
	...
	glad_glDepthBoundsdNV =
	    (PFNGLDEPTHBOUNDSDNVPROC)load("glDepthBoundsdNV");
}
...
static void load_GL_NV_fence(GLADloadproc load) {
	...
	glad_glDeleteFencesNV =
	    (PFNGLDELETEFENCESNVPROC)load("glDeleteFencesNV");
...
static void load_GL_NV_gpu_multicast(GLADloadproc load) {
	...
	glad_glMulticastBufferSubDataNV =
	    (PFNGLMULTICASTBUFFERSUBDATANVPROC)load(
...
static void load_GL_NV_gpu_program4(GLADloadproc load) {
	...
	glad_glProgramEnvParameterI4iNV =
	    (PFNGLPROGRAMENVPARAMETERI4INVPROC)load(
...
static void load_GL_NV_occlusion_query(GLADloadproc load) {
	...
	glad_glDeleteOcclusionQueriesNV =
	    (PFNGLDELETEOCCLUSIONQUERIESNVPROC)load(
...
static void load_GL_NV_path_rendering(GLADloadproc load) {
	...
	glad_glPathCommandsNV =
	    (PFNGLPATHCOMMANDSNVPROC)load("glPathCommandsNV");
	...
	glad_glPathStencilDepthOffsetNV =
	    (PFNGLPATHSTENCILDEPTHOFFSETNVPROC)load(
	...
	glad_glCoverFillPathInstancedNV =
	    (PFNGLCOVERFILLPATHINSTANCEDNVPROC)load(
	...
	glad_glPathColorGenNV =
	    (PFNGLPATHCOLORGENNVPROC)load("glPathColorGenNV");
...
static void load_GL_NV_present_video(GLADloadproc load) {
	...
	glad_glGetVideoi64vNV =
	    (PFNGLGETVIDEOI64VNVPROC)load("glGetVideoi64vNV");
...
static void load_GL_NV_query_resource_tag(GLADloadproc load) {
	...
	glad_glDeleteQueryResourceTagNV =
	    (PFNGLDELETEQUERYRESOURCETAGNVPROC)load(
...
static void load_GL_NV_scissor_exclusive(GLADloadproc load) {
	...
	glad_glScissorExclusiveArrayvNV =
	    (PFNGLSCISSOREXCLUSIVEARRAYVNVPROC)load(
...
static void load_GL_NV_shader_buffer_load(GLADloadproc load) {
	...
	glad_glUniformui64vNV =
	    (PFNGLUNIFORMUI64VNVPROC)load("glUniformui64vNV");
	glad_glGetUniformui64vNV =
	    (PFNGLGETUNIFORMUI64VNVPROC)load("glGetUniformui64vNV");
...
static void load_GL_NV_shading_rate_image(GLADloadproc load) {
	...
	glad_glShadingRateSampleOrderNV =
	    (PFNGLSHADINGRATESAMPLEORDERNVPROC)load(
...
static void load_GL_NV_vdpau_interop(GLADloadproc load) {
	...
	glad_glVDPAUUnregisterSurfaceNV =
	    (PFNGLVDPAUUNREGISTERSURFACENVPROC)load(
...
static void load_GL_NV_vertex_buffer_unified_memory(GLADloadproc load) {
	...
	glad_glNormalFormatNV =
	    (PFNGLNORMALFORMATNVPROC)load("glNormalFormatNV");
...
static void load_GL_NV_vertex_program(GLADloadproc load) {
	...
	glad_glGetProgramivNV =
	    (PFNGLGETPROGRAMIVNVPROC)load("glGetProgramivNV");
...
static void load_GL_NV_video_capture(GLADloadproc load) {
	...
	glad_glVideoCaptureNV =
	    (PFNGLVIDEOCAPTURENVPROC)load("glVideoCaptureNV");
...
static void load_GL_OES_fixed_point(GLADloadproc load) {
	...
	glad_glClearDepthxOES =
	    (PFNGLCLEARDEPTHXOESPROC)load("glClearDepthxOES");
	...
	glad_glDepthRangexOES =
	    (PFNGLDEPTHRANGEXOESPROC)load("glDepthRangexOES");
	...
	glad_glLoadMatrixxOES =
	    (PFNGLLOADMATRIXXOESPROC)load("glLoadMatrixxOES");
	...
	glad_glMultMatrixxOES =
	    (PFNGLMULTMATRIXXOESPROC)load("glMultMatrixxOES");
	...
	glad_glBlendColorxOES =
	    (PFNGLBLENDCOLORXOESPROC)load("glBlendColorxOES");
	glad_glClearAccumxOES =
	    (PFNGLCLEARACCUMXOESPROC)load("glClearAccumxOES");
	...
	glad_glGetTexGenxvOES =
	    (PFNGLGETTEXGENXVOESPROC)load("glGetTexGenxvOES");
	...
	glad_glRasterPos2xOES =
	    (PFNGLRASTERPOS2XOESPROC)load("glRasterPos2xOES");
	glad_glRasterPos2xvOES =
	    (PFNGLRASTERPOS2XVOESPROC)load("glRasterPos2xvOES");
	glad_glRasterPos3xOES =
	    (PFNGLRASTERPOS3XOESPROC)load("glRasterPos3xOES");
...
static void load_GL_OES_single_precision(GLADloadproc load) {
	...
	glad_glClearDepthfOES =
	    (PFNGLCLEARDEPTHFOESPROC)load("glClearDepthfOES");
	glad_glClipPlanefOES = (PFNGLCLIPPLANEFOESPROC)load("glClipPlanefOES");
	glad_glDepthRangefOES =
	    (PFNGLDEPTHRANGEFOESPROC)load("glDepthRangefOES");
...
static void load_GL_SGIS_texture4D(GLADloadproc load) {
	...
	glad_glTexImage4DSGIS =
	    (PFNGLTEXIMAGE4DSGISPROC)load("glTexImage4DSGIS");
...
static void load_GL_SGIX_fragment_lighting(GLADloadproc load) {
	...
	glad_glFragmentLightModelfvSGIX =
	    (PFNGLFRAGMENTLIGHTMODELFVSGIXPROC)load(
	...
	glad_glFragmentLightModelivSGIX =
	    (PFNGLFRAGMENTLIGHTMODELIVSGIXPROC)load(
...
static void load_GL_SGI_color_table(GLADloadproc load) {
	...
	glad_glColorTableParameterfvSGI =
	    (PFNGLCOLORTABLEPARAMETERFVSGIPROC)load(
		"glColorTableParameterfvSGI");
	glad_glColorTableParameterivSGI =
	    (PFNGLCOLORTABLEPARAMETERIVSGIPROC)load(
...
static int find_extensionsGL(void) {
	...
	GLAD_GL_AMD_gpu_shader_half_float =
	    has_ext("GL_AMD_gpu_shader_half_float");
	...
	GLAD_GL_AMD_interleaved_elements =
	    has_ext("GL_AMD_interleaved_elements");
	...
	GLAD_GL_AMD_occlusion_query_event =
	    has_ext("GL_AMD_occlusion_query_event");
	...
	GLAD_GL_AMD_shader_stencil_export =
	    has_ext("GL_AMD_shader_stencil_export");
	GLAD_GL_AMD_shader_trinary_minmax =
	    has_ext("GL_AMD_shader_trinary_minmax");
	...
	GLAD_GL_ARB_get_texture_sub_image =
	    has_ext("GL_ARB_get_texture_sub_image");
	...
	GLAD_GL_ARB_polygon_offset_clamp =
	    has_ext("GL_ARB_polygon_offset_clamp");
	...
	GLAD_GL_ARB_robustness_isolation =
	    has_ext("GL_ARB_robustness_isolation");
	...
	GLAD_GL_ARB_shader_stencil_export =
	    has_ext("GL_ARB_shader_stencil_export");
	...
	GLAD_GL_ARB_shading_language_100 =
	    has_ext("GL_ARB_shading_language_100");
	...
	GLAD_GL_ARB_sparse_texture_clamp =
	    has_ext("GL_ARB_sparse_texture_clamp");
	...
	GLAD_GL_ARB_texture_env_crossbar =
	    has_ext("GL_ARB_texture_env_crossbar");
	...
	GLAD_GL_ARB_texture_query_levels =
	    has_ext("GL_ARB_texture_query_levels");
	...
	GLAD_GL_ARB_uniform_buffer_object =
	    has_ext("GL_ARB_uniform_buffer_object");
	...
	GLAD_GL_ATI_text_fragment_shader =
	    has_ext("GL_ATI_text_fragment_shader");
	GLAD_GL_ATI_texture_env_combine3 =
	    has_ext("GL_ATI_texture_env_combine3");
	...
	GLAD_GL_EXT_compiled_vertex_array =
	    has_ext("GL_EXT_compiled_vertex_array");
	...
	GLAD_GL_EXT_multiview_timer_query =
	    has_ext("GL_EXT_multiview_timer_query");
	...
	GLAD_GL_EXT_polygon_offset_clamp =
	    has_ext("GL_EXT_polygon_offset_clamp");
	...
	GLAD_GL_EXT_texture_filter_minmax =
	    has_ext("GL_EXT_texture_filter_minmax");
	...
	GLAD_GL_EXT_texture_mirror_clamp =
	    has_ext("GL_EXT_texture_mirror_clamp");
	...
	GLAD_GL_GREMEDY_frame_terminator =
	    has_ext("GL_GREMEDY_frame_terminator");
	...
	GLAD_GL_IBM_multimode_draw_arrays =
	    has_ext("GL_IBM_multimode_draw_arrays");
	...
	GLAD_GL_INGR_blend_func_separate =
	    has_ext("GL_INGR_blend_func_separate");
	...
	GLAD_GL_KHR_context_flush_control =
	    has_ext("GL_KHR_context_flush_control");
	...
	GLAD_GL_MESA_framebuffer_swap_xy =
	    has_ext("GL_MESA_framebuffer_swap_xy");
	...
	GLAD_GL_NVX_linked_gpu_multicast =
	    has_ext("GL_NVX_linked_gpu_multicast");
	...
	GLAD_GL_NV_primitive_shading_rate =
	    has_ext("GL_NV_primitive_shading_rate");
	...
	GLAD_GL_NV_shader_atomic_float64 =
	    has_ext("GL_NV_shader_atomic_float64");
	...
	GLAD_GL_NV_tessellation_program5 =
	    has_ext("GL_NV_tessellation_program5");
	...
	GLAD_GL_NV_texture_expand_normal =
	    has_ext("GL_NV_texture_expand_normal");
	...
	GLAD_GL_NV_vertex_program2_option =
	    has_ext("GL_NV_vertex_program2_option");
	...
	GLAD_GL_SGIX_convolution_accuracy =
	    has_ext("GL_SGIX_convolution_accuracy");
	...
	GLAD_GL_SGIX_texture_multi_buffer =
	    has_ext("GL_SGIX_texture_multi_buffer");
